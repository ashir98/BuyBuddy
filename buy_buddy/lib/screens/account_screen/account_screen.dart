...
import 'package:buy_buddy/main.dart';
import 'package:buy_buddy/provider/app_provider.dart';
import 'package:buy_buddy/screens/about_screen/about_screen.dart';
import 'package:buy_buddy/screens/edit_profile_screen/edit_profile_screen.dart';
import 'package:buy_buddy/screens/favourites_screen/favourites_screen.dart';
import 'package:buy_buddy/screens/order_screen/order_screen.dart';
import 'package:buy_buddy/widgets/setting_list_tile.dart';
                      ...
                      child: Card(
                        ...
                        child: Center(
                          child: Column(
                            ...
                            children: [
                              CircleAvatar(radius: 60,backgroundImage: NetworkImage(appProvider.getUserInfo.image!)),
                              Text(appProvider.getUserInfo.name,style: TextStyle(color: AppColor.primaryColor,fontSize: size.width * 0.06)),
                          ...
                          actions: [
                            ...
                            TextButton(
                              onPressed: () {
                                ...
                                Routes.pushAndRemoveUntill(BuyBuddy(), context);

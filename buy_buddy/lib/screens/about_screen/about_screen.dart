      ...
      body: Padding(
        ...
        child: Column(
          children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text("Made with ",style: TextStyle(color: Colors.black87,fontSize: size.width * 0.042),),
                          Icon(EneftyIcons.heart_bold,color: Colors.red,size: size.width * 0.06,),
                          Text(" by Ashir",style: TextStyle(color: Colors.black87,fontSize: size.width * 0.042),)
                        ],
                      ),
                    ],
                  ),
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: CircleAvatar(
                        radius: 60,
                        backgroundImage: AssetImage(AssetImages().dp),
                      ),
                    ),
                    8.ph,
                    Text("Designer & Developer",style: TextStyle(color: Colors.black87, fontSize: size.width * 0.042),),
                    5.ph,
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        5.pw,
                        Text("Syed Ashir Ali",style: TextStyle(color: Colors.black87,fontSize: size.width * 0.042),)
                      ],
                    ),
                    5.ph,
                    Row(
            ...
            Text("Copyrights \u00a9 Syed Ashir Ali",style: TextStyle(fontSize: size.width * 0.04))
          ],
        ),
      ),
    );
